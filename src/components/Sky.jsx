...
function Sky() {
  ...
  useEffect(() => {
    mesh.current.position.set(planeCenter.x, planeCenter.y, planeCenter.z);
      ...
      <mesh ref={mesh}>
        ...
        <shaderMaterial
          ...
          fragmentShader={`
            ...
            void main() {
              // use noise to create a sky
              vec2 uv = vUv;
              float noise = getNoise(vec3(uv * noiseScale, uTime * noiseTimeScale));
              noise = noise * 1.0;  //more contrast
